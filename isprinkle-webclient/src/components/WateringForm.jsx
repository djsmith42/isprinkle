...
class WateringForm extends React.Component {
  ...
  render() {
    ...
    if (isSaving) {
      return (
        <div className="WateringFormSaving">
      ...
      return (
        <form className="WateringForm" onSubmit={this.preventSubmit}>
          ...
          <div className="form-group">
            ...
            <select ref="scheduleType" defaultValue={this.state.scheduleType} onChange={this.formChanged.bind(this)} className="form-control">
          ...
          <div>
            <button type="button" className="btn btn-default" onClick={this.cancelClicked.bind(this)}>Cancel</button>
            <button type="button" className="btn btn-primary" onClick={this.saveClicked.bind(this)}>Save</button>
          </div>
        </form>
      )
    }
